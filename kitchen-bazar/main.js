    ...
    function boot() {
        ...
        function preload() {
            ...
            /*dataLayer.push({
                ...
                'param1': settings.scenes[progress].url // string: can be % or url of the scene 
            });*/
        }
        // hoang.dao end
        ...
        var onStart = function() {
            ...
            if (true) {
                ...
                if (cc.sys.isMobile) {
                    ...
                    ].indexOf(cc.sys.browserType) < 0);*/ // uck remove fullscreen
                }
        ...
        var option = {
            ...
            renderMode: 0 // auto webGL fist. <%=renderMode%>
        }
