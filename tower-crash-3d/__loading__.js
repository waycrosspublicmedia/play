...
pc.script.createLoadingScreen(function (app) {
    ...
    var setProgress = function (value) {
        ...
        if (text) {
            ...
            text.innerHTML = Math.floor(value * 99) + '%';
        }
    ...
    var createCss = function () {
        var css = [
            ...
            '   top: calc(48% - 168px);',
            '   width: 117px;',
            '   animation: appear 1s ease-out, rotate-backwards 1.5s linear infinite;',
            '   transition: width 0.2s;',
    ...
    var injectForcedModeProperties = function () {
        ...
        if (isUIHidden('score')) {
            app.root.findByName('GamePlayUI').findByName('CenterContainer').enabled = false;
        }
    };
