...
playState.create = function(){
	...
	resizeGame = function(scale, bounds){
		...
		if(window.famobi.getOrientation() == "portrait"){
			...
			gameInfo.menuButton.scale = new Point(.35, .35);
		...
		var margin = String(Math.abs(fenster.innerHeight - document.getElementById("mygame").clientHeight) / 2) + "px";
	...
	function initGUI(){
		...
		//debug
		gameInfo.debugText = new Phaser.BitmapText(game, game.width - 1, 20, 'font7', "", 34);
		...
		if(projectInfo.mode == 2){
			var p1Text = new Phaser.BitmapText(game, 124, -(gameInfo.humanIcon.height - 204), 'font7', '1', 80);
			p1Text.anchor = new Phaser.Point(.5, .5);
			p1Text.tint = 0;
			gameInfo.humanIcon.addChild(p1Text);
		}
		gameInfo.guiCanvas.addChild(gameInfo.humanIcon);
		gameInfo.humanIcon.anchor = new Point(0, 1);
		gameInfo.humanIcon.scale = new Point(.5, .5);
		...
		if(projectInfo.mode == 1){
			...
			var p2Text = new Phaser.BitmapText(game, 124, -(gameInfo.humanIcon.height - 81), 'font7', '2', 80);
			p2Text.anchor = new Phaser.Point(.5, .5);
			p2Text.tint = 0;
			gameInfo.aiIcon.addChild(p2Text);
		}
		gameInfo.guiCanvas.addChild(gameInfo.aiIcon);
		gameInfo.aiIcon.anchor = new Point(1, 1);
		gameInfo.aiIcon.scale = new Point(.5, .5);
		...
		gameInfo.scoreText = new Phaser.BitmapText(game, 0, 0, 'font7', projectInfo.score, 56);
		...
		gameInfo.menuButton.scale = new Phaser.Point(.5, .5);
		...
		gameInfo.aiWin.scale = new Phaser.Point(.5, .5);
		gameInfo.aiWin.anchor = new Phaser.Point(.6, .6);
		...
		gameInfo.playerWin.scale = new Phaser.Point(.5, .5);
		...
		gameInfo.GOscoreIcon.anchor = new Phaser.Point(.5, .1);
		gameInfo.GOscoreIcon.scale = new Phaser.Point(.45, .45);
		gameInfo.gameOverPanel.addChild(gameInfo.GOscoreIcon);

		gameInfo.GOhighScoreIcon = new Phaser.Sprite(game, 270, -256, 'highScore');
		gameInfo.GOhighScoreIcon.anchor = new Phaser.Point(.5, .25);
		gameInfo.GOhighScoreIcon.scale = new Phaser.Point(.5, .5);
		gameInfo.gameOverPanel.addChild(gameInfo.GOhighScoreIcon);

		gameInfo.GOaiLevel = new Phaser.Sprite(game, 70, -5, 'aiLevel');
		gameInfo.GOaiLevel.anchor = new Phaser.Point(.5, .5);
		gameInfo.GOaiLevel.scale = new Phaser.Point(.8, .8);
		gameInfo.gameOverPanel.addChild(gameInfo.GOaiLevel);

		gameInfo.GOclockIcon = new Phaser.Sprite(game, -180, -5, 'clockIcon');
		gameInfo.GOclockIcon.anchor = new Phaser.Point(.5, .5);
		gameInfo.GOclockIcon.scale = new Phaser.Point(.55, .55);
		...
		gameInfo.p1Icon = new Phaser.Sprite(game, p1Position.x, p1Position.y, 'humanIcon');
		gameInfo.p1Icon.anchor = new Phaser.Point(.5, .5);
		gameInfo.p1Icon.scale = new Phaser.Point(.5, .5);
		...
		rosette.anchor = new Phaser.Point(.5, .5);
		...
		gameInfo.p2Icon = new Phaser.Sprite(game, p2Position.x, p2Position.y, 'humanIcon');
		gameInfo.p2Icon.anchor = new Phaser.Point(.5, .5);
		gameInfo.p2Icon.scale = new Phaser.Point(.5, .5);
		...
		gameInfo.gameOverPanel.text1 = new Phaser.BitmapText(game, 0, -180, 'font7', 'xxx', 56);
		gameInfo.gameOverPanel.text2 = new Phaser.BitmapText(game, 0, -209, 'font7', 'xxx', 56);
		gameInfo.gameOverPanel.text3 = new Phaser.BitmapText(game, -110, -28, 'font7', 'xxx', 56);
		gameInfo.gameOverPanel.text4 = new Phaser.BitmapText(game, 135, -28, 'font7', 'xxx', 56);
		...
		//return to main menu
		gameInfo.quitButton2 = new Phaser.Button(game, 90, btnPositionY, 'quitButton', gameToMenu, this, 1, 0, 1);
		gameInfo.quitButton2.anchor = new Phaser.Point(.5, .5);
		gameInfo.quitButton2.scale = new Phaser.Point(.5, .5);
		gameInfo.gameOverPanel.addChild(gameInfo.quitButton2);

		//restart game
		gameInfo.replayButton = new Phaser.Button(game, -90, btnPositionY, 'replayButton', replayGame, this, 1, 0, 1);
		gameInfo.replayButton.anchor = new Phaser.Point(.5, .5);
		gameInfo.replayButton.scale = new Phaser.Point(.5, .5);
		...
		gameInfo.popUpPanelBG.scale = new Point(.75, 1);
		gameInfo.popUpPanelBG.anchor = new Point(.5, .5);
		gameInfo.popUpPanel.addChild(gameInfo.popUpPanelBG);
		
		//resume game
		gameInfo.playButtonPU = new Phaser.Button(game, 0, 0, 'playButton', resume, this, 1, 0, 1, 0);
		gameInfo.playButtonPU.scale = new Point(.75, .75);
		...
		gameInfo.quitButtonPU.scale = new Phaser.Point(.5, .5);
		...
		gameInfo.replayButtonPU.scale = new Phaser.Point(.5, .5);
		...
		gameInfo.muteButtonPU.scale = new Phaser.Point(.5, .5);
