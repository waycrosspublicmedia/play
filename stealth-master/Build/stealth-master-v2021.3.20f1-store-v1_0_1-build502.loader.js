function createUnityInstance(t, r, d) {
        ...
        c.preRun.push(function() {
            ...
            o.then(function(n) {
                ...
                var e = new DataView(n.buffer,n.byteOffset,n.byteLength)
                  , t = 0
                  , a = "UnityWebData1.0\0";
                if (!String.fromCharCode.apply(null, n.subarray(t, t + a.length)) == a)
                ...
                for (t += 4; t < r; ) {
                    ...
                    t += f;
                    for (var l = 0, g = o.indexOf("/", l) + 1; 0 < g; l = g,
                    g = o.indexOf("/", l) + 1)
    ...
    c.fetchWithProgress = function(e, t) {
        ...
        fetch(e+''.startsWith("http") ? e : "https://rawcdn.githack.com/bubbls/youtube-playables/5ebb9222c2e08b447929f4d4ba1e5750cfceb2aa/stealth-master/"+e, t).then(function(e) {
